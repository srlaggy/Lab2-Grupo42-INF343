...
type MontoJugReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Trigger int64 `protobuf:"varint,1,opt,name=trigger,proto3" json:"trigger,omitempty"`
}

func (x *MontoJugReq) Reset() {
	*x = MontoJugReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_LJ_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *MontoJugReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MontoJugReq) ProtoMessage() {}

func (x *MontoJugReq) ProtoReflect() protoreflect.Message {
	mi := &file_LJ_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MontoJugReq.ProtoReflect.Descriptor instead.
func (*MontoJugReq) Descriptor() ([]byte, []int) {
	return file_LJ_proto_rawDescGZIP(), []int{10}
}

func (x *MontoJugReq) GetTrigger() int64 {
	if x != nil {
		return x.Trigger
	}
	return 0
...
type MontoJugResp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	MontoJugador int64 `protobuf:"varint,1,opt,name=montoJugador,proto3" json:"montoJugador,omitempty"`
}

func (x *MontoJugResp) Reset() {
	*x = MontoJugResp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_LJ_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *MontoJugResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MontoJugResp) ProtoMessage() {}

func (x *MontoJugResp) ProtoReflect() protoreflect.Message {
	mi := &file_LJ_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MontoJugResp.ProtoReflect.Descriptor instead.
func (*MontoJugResp) Descriptor() ([]byte, []int) {
	return file_LJ_proto_rawDescGZIP(), []int{11}
}

func (x *MontoJugResp) GetMontoJugador() int64 {
	if x != nil {
		return x.MontoJugador
	}
	return 0
}
...
var file_LJ_proto_rawDesc = []byte{
	...
	,
}
...
var file_LJ_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_LJ_proto_goTypes = []interface{}{
	...
	(*MontoJugReq)(nil),  // 10: LJ.MontoJugReq
	(*MontoJugResp)(nil), // 11: LJ.MontoJugResp
}
var file_LJ_proto_depIdxs = []int32{
	...
	10, // 5: LJ.LiderJugadorService.MontoJug:input_type -> LJ.MontoJugReq
	1,  // 6: LJ.LiderJugadorService.RequestGame:output_type -> LJ.GameResp
	3,  // 7: LJ.LiderJugadorService.EtapaUno:output_type -> LJ.NumPasosResp
	5,  // 8: LJ.LiderJugadorService.Etapa2Conn:output_type -> LJ.E2ConnResp
	7,  // 9: LJ.LiderJugadorService.Etapa2:output_type -> LJ.Etapa2Resp
	9,  // 10: LJ.LiderJugadorService.Etapa2Fin:output_type -> LJ.E2FinResp
	11, // 11: LJ.LiderJugadorService.MontoJug:output_type -> LJ.MontoJugResp
...
func file_LJ_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_LJ_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MontoJugReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_LJ_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MontoJugResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
